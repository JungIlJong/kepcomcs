package com.kepco.app.domain.banner.mapper;
 ...
 * </pre>
 */
@Mapper("bannerSysMapper")
public interface BannerSysMapper {
     ...
     * @param banner 배너 DTO
     */
    void insertBanner(SysBanner banner);
     ...
     * @param banner 배너 DTO
     */
    void updateBanner(SysBanner banner);
