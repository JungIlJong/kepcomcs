package com.daonplace.vasanta.domain.bbs.service;
 ...
 * </pre>
 */
public interface BbsSysService {
     ...
     * @throws FdlException
     */
    void insertBbs(SysBbs bbs) throws FdlException;
     ...
     */
    void deleteBbsById(String bbsId) throws IOException;
     ...
     * @return 게시판 상세정보
     */
    Map<String, Object> selectBbsPermissionInfo(String bbsId);
