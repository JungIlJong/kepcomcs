package com.daonplace.vasanta.domain.popup.dto;
...
@Getter
@Setter
public class InsertSysPopup {

    /**
     * 팝업명
     */
    @NotBlank(message = "{popup.popupNm.notblank}")
    @Size(max = 60, min = 1, message = "{popup.popupNm.size}")
     ...
     * 반영여부
     */
    @Size(min = 1, max = 1, message = "{popup.ntceAt.size}")
     ...
     * 팝업 이미지 파일
     */
    @NotNull(message = "{popup.imgFile.notnull}")
