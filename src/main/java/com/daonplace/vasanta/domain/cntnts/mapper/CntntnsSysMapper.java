...
/**
 * 관리자가 콘텐츠를 관리하기 위한 Mapper 인터페이스
 *
 * @author 기업부설연구소 김선홍
 * @since 2024.03.28
 * @
 ...
 * </pre>
 */
@Mapper("contentSysMapper")
public interface CntntnsSysMapper {
     ...
     */
    void saveCntnts(Content content);
     ...
     * @param content 콘텐츠 DTO
     */
    void updateCntnts(Content content);
