package com.daonplace.vasanta.domain.answer.mapper;
 ...
 * </pre>
 */
@Mapper("answerSysMapper")
public interface AnswerSysMapper {
     ...
     * @param answer 댓글 DTO
     */
    void insertAnswer(SysAnswer answer);
