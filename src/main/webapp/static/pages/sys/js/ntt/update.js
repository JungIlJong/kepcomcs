...
document.addEventListener('DOMContentLoaded', function (e) {
    ...
    const dt_answer_table = document.querySelector('.datatables-answers'),
    ...
    // Users datatable
    if (dt_answer_table) {
        const dt_answer = new DataTable(dt_answer_table, {
            ajax: {
                url: '/api/sys/answer/list',
                type: "GET",
                dataSrc: 'data',
                data: function (d) {
                    d.nttId = $('#nttId').val();
            ...
            columnDefs: [
                ...
                },
                {
                    ...
                    render: (data, type, full, meta) => {
                        let resData = '<div class="d-flex align-items-center">';
                        if (data.useAt === 'Y') {
                            resData += `<a onclick="updateAnswerButton(this)" href="#!" data-id="${data.answerId}" data-stts="${data.useAt}" class="btn btn-icon delete-record">
                                       <i class="icon-base bx bx-show icon-md"></i></a>`
                        } else {
                            resData += `<a onclick="updateAnswerButton(this)" href="#!" data-id="${data.answerId}" class="btn btn-icon delete-record">
                                         <i class="icon-base bx bx-hide icon-md"></i></a>`
                        }
                        resData += `<a onclick="deleteAnswerButton(this)" href="#!" data-id="${data.answerId}" class="btn btn-icon delete-record">
                                    <i class="icon-base bx bx-trash icon-md"></i></a></div>`;
                        return resData;
                    }
                }
            ],
        ...
        function deleteRecord(event) {
            ...
            if (row) {
                dt_answer.row(row).remove().draw();
            }
        }

        function bindDeleteEvent() {
            const userListTable = document.querySelector('.datatables-answers');
...
// Create date inputs
minDate = new DateTime('#stDt', {
    format: 'YYYY-MM-DD'
});
maxDate = new DateTime('#endDt', {
    format: 'YYYY-MM-DD'
});
