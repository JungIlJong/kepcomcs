    ...
    const dt_user = new DataTable(dt_user_table, {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          title: '상태',
          render: function (data, type, full, meta) {
            if (data === 'A') return '<span class="badge text-bg-primary">승인</span>';
            else if (data === 'P') return '<span class="badge text-bg-success">신청</span>';
            else if (data === 'D') return '<span class="badge text-bg-dark">탈퇴</span>';
            else if (data === 'B') return '<span class="badge text-bg-danger">차단</span>';
          }
        },
        {
          targets: -1,
          ...
          render: (data, type, full, meta) => {
            return `
              <div class="d-flex gap-1 justify-content-center">
                <button onclick="location.href='/sys/system/mbr/mbr/detail?uuid=${data}'" class="btn btn-sm btn-label-secondary">
                  <i class="icon-base bx bx-pencil icon-xs"></i>수정
                </button>              
                <button onclick="deleteUser('${data}')" class="btn btn-sm btn-label-danger">
