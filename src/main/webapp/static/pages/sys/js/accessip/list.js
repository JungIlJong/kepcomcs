...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_accessip_table = document.querySelector('.datatables-accessips'),
  ...
  // Users datatable
  if (dt_accessip_table) {
    const dt_banner = new DataTable(dt_accessip_table, {
      ajax: {
        url: '/api/sys/accessip/list',
        type: "GET",
        dataSrc: 'data',
        data: function (d) {
          return d;
          ...
          render: (data, type, full, meta) => {
            return `
              <div class="d-flex gap-1 justify-content-center">
                <button onclick="location.href='detail?ipId=${data}'" class="btn btn-sm btn-label-secondary">
                  <i class="icon-base bx bx-pencil icon-xs"></i>수정
                </button>
                <button onclick="deleteAccessIp('${data}')" class="btn btn-sm btn-label-danger">
    ...
    function bindDeleteEvent() {
      const userListTable = document.querySelector('.datatables-accessips');
