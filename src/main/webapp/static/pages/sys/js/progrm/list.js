...
document.addEventListener('DOMContentLoaded', function (e) {
    ...
    const dt_program_table = document.querySelector('.datatables-programs'),
    ...
    // Users datatable
    if (dt_program_table) {
        const dt_user = new DataTable(dt_program_table, {
            ajax: {
            ...
            columnDefs: [
              ...
              <div class="d-flex gap-1 justify-content-center">
                <button class="btn btn-sm btn-label-secondary" onclick="location.href='detail?progrmId=${data}'">
                  <i class="icon-base bx bx-pencil icon-xs"></i>수정
                </button>
                <button onclick="deleteProgram('${data}')" class="btn btn-sm btn-label-danger">
        ...
        function bindDeleteEvent() {
            const userListTable = document.querySelector('.datatables-programs');
