    ...
    const dt_push = new DataTable(dt_push_table, {
      ...
      columnDefs: [
        ...
        },
        {
          ...
          orderable: false,
          render: function (data, type, full, meta) {
            return `${(data.successCount / data.sentCount) * 100}% (${data.successCount}/${data.sentCount})`
          }
        },
        {
          // Plans
          ...
          render: (data, type, full, meta) => {
            return `
              <div class="d-flex gap-1 justify-content-center">
                <button class="btn btn-sm btn-outline-secondary" onclick="downloadPushLog('${data}');">
                    <i class="icon-base bx bx-arrow-to-bottom icon-md"></i>다운로드
                </button>
              </div>
            `;
          }
