		...
		this
			...
			.each(function () {
				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					t.row.add( ['<a href="javascript:tmp(0)">.1</a>','.2', '.3'] ).draw( false );
					console.log("ROW INDEX : " + t.data().count()/3)
					...
					//$.each(files, function (i, file) {
						...
						console.log("여기 언제 들어오지 : " + MultiFile.STRING.remove);
						var
