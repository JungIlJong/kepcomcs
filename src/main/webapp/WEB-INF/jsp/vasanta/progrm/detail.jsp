...
<head>
    ...
    <script type="text/javascript">
        <%-- 상세조회 성공 시 Callback 함수 --%>
        let successDetail = function (data) {
            document.getElementById('progrmId').value = data.progrmId;
            document.getElementById('progrmNm').value = data.progrmNm;
            document.getElementById('progrmUrl').value = data.progrmUrl;
            document.getElementById('progrmDc').value = data.progrmDc;
        }
                        ...
                        <div class="order-0 order-md-1">
                            <div class="card mb-6">
                                <div class="card-header">
                                    <h5 class="mb-0">프로그램 수정</h5>
                                </div>
                                <div class="card-body pt-0">
                                    <form id="frm">
                                        <input type="hidden" name="progrmId" id="progrmId">
...
<script type="text/javascript">
    $(function () {
        ...
        let progrmId = params.get("progrmId");

        Ajax.get('/api/sys/progrm/detail?progrmId=' + progrmId, successDetail, fail);
                ...
                if (status === 'Valid') {
                    customAlert({
                        ...
                        onConfirm: function () {
                            ...
                            Ajax.post('/api/sys/progrm/update', successUpdate, fail, { data: JSON.stringify(data) });
                        }
                    });
                }
            });
        ...
        document.getElementById('btnDelete').addEventListener('click', function () {
            customAlert({
                ...
                onConfirm: function () {
                    let data = {
                        progrmId: document.getElementById('progrmId').value
                    };
                    Ajax.post('/api/sys/progrm/delete', successDelete, fail, { data: JSON.stringify(data) });
                }
            });
        });
    });
