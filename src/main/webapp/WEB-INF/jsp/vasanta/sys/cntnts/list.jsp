...
<%--            Ajax.get(dataToQueryString('/api/sys/cntnts/list', data), success, fail);--%>
<%--        }--%>
...
<%--                        <a href="detail?cntntsId=${'${element.cntntsId}'}">${'${element.cntntsNm}'}</a>--%>
<%--                      </td>--%>
<%--                      <td class="tblBodyItem item01">--%>
<%--                        ${'${element.mngrId}'}--%>
<%--                      </td>--%>
    ...
    <script type="text/javascript">
        ...
        let successDelete = function (data) {
            customAlert({
                ...
                showCancel: false,
                onConfirm: function() {
                    new DataTable('.datatables-cntnts').draw();
                }
            });
        }
                        ...
                        <div class="row card-body">
                            ...
                            <div class="justify-content-between dt-layout-table">
                                <div class="justify-content-between align-items-center dt-layout-full table-responsive">
                                    <table class="datatables-cntnts table border-top dataTable dtr-column"
...
<script src="/static/pages/sys/js/cntnts/list.js"></script>
<script type="text/javascript">
    $(function () {
        let dt_cntnt = new DataTable('.datatables-cntnts');
        // Refilter the table
        document.querySelectorAll('#stDt, #endDt').forEach((el) => {
            el.addEventListener('change', () => dt_cntnt.draw());
        });
