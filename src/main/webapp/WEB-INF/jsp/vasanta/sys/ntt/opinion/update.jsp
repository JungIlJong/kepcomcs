                                    ...
                                    <form id="frm">
                                        ...
                                        <div class="table-responsive text-nowrap">
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <th>
                                                        <label class="form-label" for="cpNm">
                                                            고객 회사명
                                                        </label>
                                                    </th>
                                                    <td colspan="3">
                                                        <div class="form-control-validation fv-plugins-icon-container">
                                                            <div class="flex-c gap-2">
                                                                <div class="has-validation w-100">
                                                                    <input class="form-control" type="text" name="cpNm"
                                                                           id="cpNm" placeholder="">
                                                                </div>
                                                            </div>
                                                            <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
								                ...
								                <tr>
                                                    <th>
                                                        <label class="form-label" for="feedbackYn">
                                                        회신여부
                                                        </label>
                                                    </th>
                                                    <td colspan="3">
...
<script>
    ...
    $(function () {
        ...
        let setDetail = function (data) { console.log(data);
            ...
            $('#feedbackYn').text(data.feedbackYn === 'Y' ? '예' : '아니오');
