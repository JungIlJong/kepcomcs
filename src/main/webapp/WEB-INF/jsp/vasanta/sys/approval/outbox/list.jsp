                            ...
                            <div class="card-datatable">
                                    ...
                                    <div class="row mx-3 my-0 justify-content-between">
                                        <div>
                                            <div class="row me-4 mb-4 col-12 justify-content-between">
                                                <div class="col-6">
                                                    <form id="inboxSearchForm">
                                                        <div class="form-control-validation fv-plugins-icon-container">
                                                            <label class="form-label" for="approvalStatus">상태</label>
                                                            <select class="form-control form-select" id="approvalStatus" name="approvalStatus">
                                                                <option value="">선택</option>
                                                                <option value="N">결재요청</option>
                                                                <option value="P">결재중</option>
                                                                <option value="A">결재완료</option>
                                ...
                                <div class="justify-content-between dt-layout-table">
                                    <div class="justify-content-between align-items-center dt-layout-full table-responsive">
                                        <table class="datatables-inboxes table border-top dataTable dtr-column"
...
<!--/ Layout wrapper -->
<script src="/static/pages/sys/js/approval/outbox/list.js"></script>
</body>
