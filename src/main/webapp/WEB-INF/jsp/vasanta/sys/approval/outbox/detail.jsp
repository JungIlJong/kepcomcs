        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    <div class="row invoice-preview">
                        ...
                        <div class="col-xl-8 col-md-8 col-12 mb-md-0 mb-6">
                            <div class="card invoice-preview-card p-sm-12 p-6">
                                ...
                                <div id="approvalContent" class="card-body invoice-preview-header rounded"></div>
                            </div>
                        </div>
                        <!-- /Invoice -->
                        ...
                        <div class="col-xl-4 col-md-4 col-12 invoice-actions">
                            <div class="card">
                                <div class="card-body">
                                    <div id="approvalLines" class="card-body"></div>
                                </div>
                            </div>
                        </div>
                        <!-- /Invoice Actions -->
                    ...
                    <button id="btnCancel" class="btn btn-danger mt-3 left d-none">
                        <span class="d-flex align-items-center justify-content-center text-nowrap">취소</span>
                    </button>
                </div>
...
<!--/ Layout wrapper -->
<script src="/static/pages/sys/js/approval/outbox/detail.js"></script>
</body>
</html>
