...
<%--                                            <tr><th>상세 사유</th><td id="detailMessage"></td></tr>--%>
                                            <tr><th>회원명</th><td id="mbrName"></td></tr>
                                            <tr><th>이메일</th><td id="mbrEmail"></td></tr>
                                            <tr><th>휴대폰번호</th><td id="mbrMobile"></td></tr>
                                            </tbody>
                                        </table>
                                    </div>
...
<script src="/static/pages/sys/js/report/mbrDetail.js"></script>
</body>
</html>
