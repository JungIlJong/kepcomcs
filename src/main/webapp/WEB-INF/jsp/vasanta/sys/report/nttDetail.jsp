...
<%--                                            <tr><th>상세 사유</th><td id="detailMessage"></td></tr>--%>
                                            <tr><th>게시글 제목</th><td id="nttTitle"></td></tr>
                                            <tr><th>게시글 작성자</th><td id="writerName"></td></tr>
                                            <tr><th>게시글 내용</th><td id="nttContent"></td></tr>
                                            </tbody>
                                        </table>
                                    </div>
...
<script src="/static/pages/sys/js/report/nttDetail.js"></script>
</body>
</html>
