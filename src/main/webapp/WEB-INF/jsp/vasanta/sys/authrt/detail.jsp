...
<head>
    ...
    <script type="text/javascript">
        <%-- 롤조회 성공 시 Callback 함수 --%>
        let success = function (data) {
            document.getElementById('authrtId').value = data.authrtId;
            document.getElementById('authrtCd').value = data.authrtCd;
            document.getElementById('authrtNm').value = data.authrtNm;
            document.getElementById('authrtExpln').value = data.authrtExpln;
            let menuList = data.menuList;
            menuList.forEach(function (menu) {
                $('#tree').jstree(true).check_node(menu.menuId);
            });
        }
        ...
        let successMenu = function (data) {
            ...
            let authrtId = params.get("authrtId");
            ...
            Ajax.get('/api/sys/authrt/detail?authrtId=' + authrtId, success, fail);
        }
            ...
            <div class="content-wrapper">
                <div class="container-xxl flex-grow-1 container-p-y">
                    ...
                    <div class="row mb-6 gy-6">
                        ...
                        <div class="col-xl">
                            <div class="card h-100">
                                <h5 class="card-header">권한 정보 수정</h5>
                                <form id="frm">
                                    <div class="card-body">
                                            ...
                                            <div class="mb-4 col-12 form-control-validation fv-plugins-icon-container">
                                                ...
                                                <div class="has-validation">
                                                    <input class="form-control" type="text" name="authrtCd"
                                                           id="authrtCd" maxlength="30" placeholder="권한코드를 입력하세요.">
                                                </div>
                                            ...
                                            <div class="mb-4 col-12 form-control-validation fv-plugins-icon-container">
                                                ...
                                                <div class="has-validation">
                                                    <input class="form-control" type="text" name="authrtNm"
                                                           id="authrtNm" maxlength="60" placeholder="권한명을 입력하세요.">
                                                </div>
                                                <div class="fv-plugins-message-container fv-plugins-message-container--enabled invalid-feedback"></div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="d-flex justify-content-between mt-5">
                                                ...
                                                <div>
                                                    ...
                                                    <button type="button" class="btn btn-primary" id="btnUpdate">
                                                        <spring:message code="button.modify"/></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    $(function () {
        ...
        document.getElementById('btnUpdate').addEventListener('click', function () {
            ...
            fvAuthrtInstance.validate().then(function (status) {
                if (status === 'Valid') {
                    const authrtId = document.getElementById('authrtId').value;
                    ...
                    customAlert({
                        ...
                        onConfirm: function () {
                            ...
                            Ajax.post('/api/sys/authrt/update', successUpdate, fail, { data: JSON.stringify(data) });
                        }
                    });
                }
            });
        ...
        document.getElementById('btnDelete').addEventListener('click', function () {
            customAlert({
                ...
                onConfirm: function () {
                    let data = {
                        authrtId: document.getElementById('authrtId').value
                    };
                    Ajax.post('/api/sys/authrt/delete', successDelete, fail, { data: JSON.stringify(data) });
                }
            });
        });
