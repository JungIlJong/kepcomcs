    ...
    <script type="text/javascript">
        ...
        let successDelete = function (data) {
            customAlert({
                ...
                showCancel: false,
                onConfirm: function() {
                    new DataTable('.datatables-authrts').draw();
                }
            });
        }
                            ...
                            <div class="card-datatable">
                                <div class="justify-content-between dt-layout-table">
                                    <div class="justify-content-between align-items-center dt-layout-full table-responsive">
                                        <table class="datatables-authrts table border-top dataTable dtr-column"
...
<script src="/static/pages/sys/js/authrt/list.js"></script>
<script type="text/javascript">
    $(function () {
        let dt_authrt = new DataTable('.datatables-authrts');
        dt_authrt.draw();
    });

    function deleteAuthrt(authrtId) {
        if (confirm('<spring:message code="confirm.common.delete"/>')) {
            const data = {
                "authrtId": authrtId.toString()
            };
