...
<div id="step1" class="secretItem justify-content-center">
    <div class="card-body mt-6">
        <div class="d-flex flex-column mb-4 align-items-center">
            <h4 class="card-title mb-1">비밀글 기능으로 보호된 글입니다.</h4>
            <p class="mb-6 text-center">작성자와 관리자만 열람하실 수 있습니다.<br/>
                본인이라면 비밀번호를 입력하세요.</p>
...
<div id="step2" class="card-header border-bottom d-none">
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
        ...
        <div class="d-flex align-content-center flex-wrap gap-4">
            <div class="d-flex gap-4">
                <button class="btn btn-label-danger" id="deleteUBtn" onclick="deleteCall()"><spring:message code="button.delete"/></button>
                <button class="btn btn-label-primary" id="updateUBtn" onclick="clickUpdate()"><spring:message code="button.modify"/></button>
            </div>
        </div>
    </div>
    <div class="d-flex flex-column flex-md-row align-content-start mb-0">
        ...
        <div class="d-flex gap-2">
            <small class="p-0 m-0 text-body-secondary">조회수</small><small class="p-0 m-0 text-body-secondary" id="rdcnt"></small>
        </div>
    </div>
    <div class="pt-4">
    <div class="d-flex flex-column align-content-between">
        ...
        <div class="d-flex justify-content-end align-items-center flex-wrap">
            <button type="button" onclick="location.href='list'" class="btn btn-primary shadow-none"><spring:message code="button.list" /></button>
        </div>
    </div>
</div>
</div>
    ...
    <div class="card">
                            <div class="card-header border-bottom">
                                <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-6 row-gap-4">
                                    ...
                                    <div class="d-flex align-content-center flex-wrap gap-4">
                                        <div class="d-flex gap-4">
                                            <button class="btn btn-label-secondary">목록</button>
                                        </div>
                                        <button type="submit" class="btn btn-primary" id="btnSave"><spring:message code="button.modify"/></button>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="container-p-y">
                                    <form id="frm" onsubmit="return false;" autocomplete="off">
                                        <input id="fileAtchSize" name="fileAtchSize" type="hidden" value="<c:out value='${bbs.fileAtchSize}'/>" />
                                        ...
                                        <c:if test="${bbs.fileAtchCo > 0}">
                                            <div class="mb-6">
                                                <div class="input-file inLine">
                                                    <input type="file" id="files" name="files" class="form-control" placeholder="파일을 선택하세요" title="파일을 선택하세요" multiple />
                                                </div>
                                            </div>
                                        </c:if>
                                        <div id="fileItem2"></div>
                                    </form>
                                </div>
                            </div>
                        </div>
</div>
<script src="/static/pages/mber/js/ntt/common/password.js"></script>