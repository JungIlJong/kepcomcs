...
<head>
    ...
    <title>안전경영소식 | 안전경영 | ESG경영 | 한전MCS</title>
                            ...
                            if (request.result == "1") {
                                ...
                                for (i = 0; i < request.data.length; i++) {
                                    if (request.data[i].view_type == "prev") {
                                        ...
                                        $("#prev_post_href").attr("href", "/esg/safety/safetynews-view?board_no=" + request.data[i].board_no);
                                    } else {
                                        $('#next_post').text(request.data[i].board_title);
                                        $("#next_post_href").attr("href", "/esg/safety/safetynews-view?board_no=" + request.data[i].board_no);
                                    }
                                }
                            }
                        }
...
<main class="esg-main esg-layout">
    ...
    <div class="contents">
        ...
        <div class="esg-tit-wrap">
            <h1>안전경영소식</h1>
            <p class="conts-desc_08 organ-tit-desc">한전MCS의 안전경영소식을 전달합니다.</p>
        </div>
        <div class="safetynews-wrap safetynews-view">
            <ul class="news-view-box">
                <li class="news-view-title" id="news-view-title">
                    <p></p>
                </li>
            ...
            <div class="btn-row-right">
                <a href="/esg/safety/safetynews-list">
