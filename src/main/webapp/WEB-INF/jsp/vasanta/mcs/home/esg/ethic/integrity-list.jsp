										...
										},
										{
											...
											"render" : function(data, type, row, meta) {
												...
												if (row.file_name != "" && row.file_name != "undefined" && row.file_name != null){
													...
													return_val = "<a href='/api/file/fileDown?file_name="+encodeURI(row.file_name)+"' class='down_zipfile' download></a>";

												}else if (row.file_name2 != ""  && row.file_name2 != "undefined" && row.file_name2 != null){
													console.log("file_name2 : " + row.file_name2);
													return_val = "<a href='/api/file/fileDown?file_name="+encodeURI(row.file_name2)+"' class='down_zipfile' download></a>";
												}else{
													console.log("file_name3 : " + row.file_name);
													return_val = "";
												}
          ...
          <table class="table display nowrap list-table esg-list integrity-list" id="pressListTable" cellspacing="0" width="100%">
            ...
            <tbody> 
              <tr>
                ...
                <td>
                  <a href="" class="down_zipfile" download></a>
                </td>
                <td>2021.10.10</td>
              </tr> 
              <tr>
