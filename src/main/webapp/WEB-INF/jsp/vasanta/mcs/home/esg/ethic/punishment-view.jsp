                            ...
                            if (request.result == "1") {
                                ...
                                for (i = 0; i < request.data.length; i++) {
                                    if (request.data[i].view_type == "prev") {
                                        ...
                                        $("#prev_post_href").attr("href", "/esg/ethic/punishment-view?board_no=" + request.data[i].board_no);
                                    } else {
                                        $('#next_post').text(request.data[i].board_title);
                                        $("#next_post_href").attr("href", "/esg/ethic/punishment-view?board_no=" + request.data[i].board_no);
                                    }
                                }
                            }
                        }
    ...
    <div class="contents">
        ...
        <div class="safetynews-wrap safetynews-view">
            <ul class="news-view-box">
                ...
                <li>
                    <div class="news-view-photo" id="news-view-photo">
                        <img src="/resources/landing/images/esg/sample_inte.jpg">
                    </div>
                    <div class="news-view-desc" id="news-view-desc">
                        ...
                        기준을 준수하여 서비 스를 제공합니다. 또한 OECD의 개인정보 보호 가이드라인 등 국제 기준을 준수하여 서비 스를 제공합니다. 또한 OECD의 개인정보 보호 가이드라인 등
                        국제 기준을 준수하여 서비 스를 제공합니다.
                    </div>
            ...
            <div class="btn-row-right">
                <a href="/esg/ethic/punishment-list">
