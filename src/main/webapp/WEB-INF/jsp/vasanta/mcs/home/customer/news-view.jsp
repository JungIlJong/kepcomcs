							...
							if(request.result == "1")
							{
								...
								for (i=0; i < request.data.length; i++){
									if(request.data[i].view_type == "prev"){
										...
										$("#prev_post_href").attr("href", "/customer/news-view?board_no=" + request.data[i].board_no);
									}else{
										$('#next_post').text(request.data[i].board_title);
										$("#next_post_href").attr("href", "/customer/news-view?board_no=" + request.data[i].board_no);
									}
								}
							}
						}
        ...
        <ul class="news-view-box">
          ...
          <li>
            <div class="news-view-photo">
              <img src="/resources/landing/images/customer/img_news.jpg" id="news-view-photo">
            </div>
