										...
										columns : [
											...
											},
											{
												...
												"render" : function(data, type, row, meta) {
													...
													return "<a href='/customer/news-view?board_no=" + row.board_no + "'>" + row.board_title + "</a>" || "";
												}
											},
											{
												"data" : "insert_dt",
          ...
          <table class="table display nowrap list-table" id="pressListTable" cellspacing="0" width="100%">
            ...
            <tbody>
              <tr>
                <td>10</td>
                <td>
                  <a href="/open-manage/press-view">
                    <p class="tbl-title">2021년 6월말 현재 수의계약현황 2021년 6월말 현재 수의계약현황2021년 6월말 현재 수의계약현황2021년 6월말 현재 수의계약현황2021년 6월말 현재 수의계약현황</p>
                  </a>
                </td>
                <td>
              ...
              <tr>
                <td>9</td>
                <td>
                  <a href="/open-manage/press-view.html">
