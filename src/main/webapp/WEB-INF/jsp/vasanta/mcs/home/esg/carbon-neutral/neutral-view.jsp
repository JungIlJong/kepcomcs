                            ...
                            if (request.result == "1") {
                                ...
                                for (i = 0; i < request.data.length; i++) {
                                    if (request.data[i].view_type == "prev") {
                                        ...
                                        $("#prev_post_href").attr("href", "/esg/carbon-neutral/neutral-view?board_no=" + request.data[i].board_no);
                                    } else {
                                        $('#next_post').text(request.data[i].board_title);
                                        $("#next_post_href").attr("href", "/esg/carbon-neutral/neutral-view?board_no=" + request.data[i].board_no);
                                    }
                                }
                            }
                        }
    ...
    <div class="contents esg-conts">
        ...
        <div class="safetynews-wrap">
            ...
            <div class="btn-row-right">
                <a href="/esg/carbon-neutral/neutral-list">
