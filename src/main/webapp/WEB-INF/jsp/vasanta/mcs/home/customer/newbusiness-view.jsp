    ...
    <div class="contents"> 
      <div class="conts-ani" data-trigger>
        ...
        <ul class="board-form board-view">
          ...
          <li class="question-desc">
            ...
            <div class="board-form-conts">
              <div class="customer-desc-box">
                한전MCS(이하 회사’)는 서비스 기획부터 종료까지 개인정보보호법 등 국내의 개인정보 보호 법령을 철저히 준수합니다. 또한 OECD의 개인정보 보호 가이드라인 등 국제 기준을 준수하여 서비스를 제공합니다. 한전MCS(이하 회사’)는 서비스 기획부터 종료까지 개인정보보호법 등 국내의 개인정보 보호 법령을 철저히 준수합니다. 또한 OECD의 개인정보 보호 가이드라인 등 국제 기준을 준수하여 서비스를 제공합니다. 한전MCS(이하 회사’)는 서비스 기획부터 종료까지 개인정보보호법 등 국내의 개인정보 보호 법령을 철저히 준수합니다. 또한 OECD의 개인정보 보호 가이드라인 등 국제 기준을 준수하여 서비스를 제공합니다.한전MCS(이하 회사’)는 서비스 기획부터 종료까지 개인정보보호법 등 국내의 개인정보 보호 법령을 철저히 준수합니다. 또한 OECD의 개인정보 보호 가이드라인 등 국제 기준을 준수하여 서비스를 제공합니다.
                또한 OECD의 개인정보 보호 가이드라인 등 국제 기준을 준수하여 서비스를 제공합니다.한전MCS(이하 회사’)는 서비스 기획부터 종료까지 개인정보보호법 등 국내의 개인정보 보호 법령을 철저히 준수합니다. 또한 OECD의 개인정보 보호 가이드라인 등 국제 기준을 준수하여 서비스를 제공합니다.
              </div>
            </div>
          </li>

          <!-- 답변이 완료된 경우 -->
          <li class="answer-desc answered-box">
          ...
          <!-- 답변 준비중인 경우 -->
          <!-- <li class="answer-desc answered-no">
            <div class="board-form-tit">답변내용</div>
            <div class="board-form-conts">
              <div class="customer-desc-box">
                <span>답변 준비중입니다.</span>
        ...
        <div class="btn-row btn-row-right">
          <a href="/customer/newbusiness-list">
