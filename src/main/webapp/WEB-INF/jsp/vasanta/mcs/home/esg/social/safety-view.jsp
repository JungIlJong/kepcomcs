                            ...
                            if (request.result == "1") {
                                ...
                                for (i = 0; i < request.data.length; i++) {
                                    if (request.data[i].view_type == "prev") {
                                        ...
                                        $("#prev_post_href").attr("href", "/esg/social/safety-view?board_no=" + request.data[i].board_no);
                                    } else {
                                        $('#next_post').text(request.data[i].board_title);
                                        $("#next_post_href").attr("href", "/esg/social/safety-view?board_no=" + request.data[i].board_no);
                                    }
                                }
                            }
                        }
    ...
    <div class="contents esg-conts social-view-conts">
        ...
        <div class="safetynews-wrap">
            <ul class="news-view-box">
                ...
                <li>
                    <div class="news-view-photo" id="news-view-photo">
                        <img src="../../images/esg/sample_inte.jpg">
                    </div>
            ...
            <div class="btn-row-right">
                <a href="/esg/social/satisfy-list">
