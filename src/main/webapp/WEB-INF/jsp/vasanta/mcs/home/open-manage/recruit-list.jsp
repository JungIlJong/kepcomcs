		         	...
		         	if(parseInt(data.result))
		     		{
		         		...
		         		for ( i = 0; i < data.data.length; i++) {
							...
							li_html = li_html + "<a href='/open-manage/recruit-view?board_no=" + data.data[i].board_no +"'>";
              				li_html = li_html +  "<p class='news-part'>" + data.data[i].recruit_status + "</p>";
							li_html = li_html +  "<p class='news-tit'>" + data.data[i].board_title + "</p>";
							li_html = li_html + "<p class='news-date'>기간 : " + data.data[i].post_start_dt + "~" + data.data[i].post_end_dt + "</p>";
							li_html = li_html + "</a>";
